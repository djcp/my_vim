...
badd +18 public/javascripts/feeds.js
badd +1 GEm
badd +32 Gemfile
...
exe '1resize ' . ((&lines * 30 + 26) / 52)
exe 'vert 1resize ' . ((&columns * 117 + 94) / 189)
exe '2resize ' . ((&lines * 19 + 26) / 52)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 31 - ((1 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
exe 'vert 2resize ' . ((&columns * 128 + 94) / 189)
exe 'vert 3resize ' . ((&columns * 29 + 94) / 189)
argglobal
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> gf <Plug>RailsTabFind
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 22 - ((20 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
...
exe 'vert 1resize ' . ((&columns * 159 + 94) / 189)
exe '2resize ' . ((&lines * 16 + 26) / 52)
exe 'vert 2resize ' . ((&columns * 159 + 94) / 189)
exe '3resize ' . ((&lines * 16 + 26) / 52)
exe 'vert 3resize ' . ((&columns * 159 + 94) / 189)
argglobal
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> gf <Plug>RailsTabFind
...
22
normal! 029l
tabedit app/views/hubs/show.html.erb
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
wincmd w
argglobal
edit spec/models/hub_feed_spec.rb
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> gf <Plug>RailsTabFind
nmap <buffer> f <Plug>RailsSplitFind
...
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 25 + 26) / 52)
exe 'vert 1resize ' . ((&columns * 158 + 94) / 189)
exe '2resize ' . ((&lines * 24 + 26) / 52)
