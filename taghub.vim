...
badd +6 app/views/shared/forms/_feed.html.erb
...
badd +0 db/migrate/20110718193629_create_hub_feeds.rb
badd +0 spec/models/hub_feed_spec.rb
badd +21 config/database.yml
...
exe 'vert 1resize ' . ((&columns * 106 + 89) / 179)
exe '2resize ' . ((&lines * 22 + 26) / 52)
exe 'vert 2resize ' . ((&columns * 106 + 89) / 179)
exe 'vert 3resize ' . ((&columns * 72 + 89) / 179)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
exe 'vert 3resize ' . ((&columns * 81 + 89) / 179)
argglobal
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> gf <Plug>RailsTabFind
...
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 25 + 26) / 52)
exe 'vert 1resize ' . ((&columns * 94 + 89) / 179)
exe '2resize ' . ((&lines * 24 + 26) / 52)
exe 'vert 2resize ' . ((&columns * 94 + 89) / 179)
exe 'vert 3resize ' . ((&columns * 84 + 89) / 179)
argglobal
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> gf <Plug>RailsTabFind
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 12 - ((6 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
12
