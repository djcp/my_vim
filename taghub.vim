...
badd +8 app/controllers/hubs_controller.rb
badd +1 app/controllers/feeds_controller.rb
badd +1 features/step_definitions/web_steps.rb
badd +2 app/views/hubs/show.html.erb
badd +1 app/views/layouts/application.html.erb
badd +1 features/step_definitions/taghub_steps.rb
badd +21 features/support/paths.rb
badd +23 ~/.vim/syntax/html.vim
badd +0 app/views/feeds/show.html.erb
silent! argdel *
...
exe '1resize ' . ((&lines * 29 + 26) / 52)
exe 'vert 1resize ' . ((&columns * 112 + 87) / 175)
exe '2resize ' . ((&lines * 20 + 26) / 52)
exe 'vert 2resize ' . ((&columns * 112 + 87) / 175)
exe 'vert 3resize ' . ((&columns * 65 + 87) / 175)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
exe 'vert 1resize ' . ((&columns * 120 + 87) / 175)
exe '2resize ' . ((&lines * 24 + 26) / 52)
exe 'vert 2resize ' . ((&columns * 120 + 87) / 175)
exe 'vert 3resize ' . ((&columns * 54 + 87) / 175)
argglobal
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> gf <Plug>RailsTabFind
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 109 - ((12 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
109
...
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 25 + 26) / 52)
exe 'vert 1resize ' . ((&columns * 96 + 87) / 175)
exe '2resize ' . ((&lines * 24 + 26) / 52)
exe 'vert 2resize ' . ((&columns * 96 + 87) / 175)
exe 'vert 3resize ' . ((&columns * 83 + 87) / 175)
argglobal
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> gf <Plug>RailsTabFind
